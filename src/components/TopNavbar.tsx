  ...
  return (
    <div className="max-w-[1286px] lg:mx-auto flex justify-between items-center p-4 sm:h-[113px] h-[80px]">
      <div
        ...
        <h1 className="hidden sm:block sm:text-3xl px-2" style={{ width: "234px" ,fontSize:'26px'}}>
          Delicias a Meta
        </h1>
      </div>
        ...
        <div
          ...
          <nav>
            <ul className="flex flex-col p-4  text-gray-900">
              <li className="text-xl py-2 ps-3 mb-2 flex bg-yellow-200 " onClick={closeSideNav}>
                <Link to="/">Home</Link>
              </li>
              <li className="text-xl py-2 ps-3 mb-2 flex  bg-yellow-200" onClick={closeSideNav}>
                <Link to="/recite">Recipe</Link>
              ...
              <li
                className="text-xl py-2 ps-3 mb-2 flex  bg-yellow-200" onClick={closeSideNav}>
                <Link to="/store">Store</Link>
              </li>
            </ul>
          </nav>
